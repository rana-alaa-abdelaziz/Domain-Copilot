...
class ModuleOutlineGenerator:
    ...
    """
    def __init__(self, retrieve_use_case: HybridRetrieveUseCase, llm_provider: LlmProvider):
    ...
    def _load_prompt_template(self):
        candidate_paths = [
            ...
            Path(__file__).resolve().parents[2] / "backend" / "prompts" / "module_outline_v1.md",
    ...
    def generate_outline(self, gap_report: CompetencyGapReport) -> ModuleOutlineReport:
        ...
        gaps_data = [{"competency": g.competency, "severity": g.severity} for g in gap_report.unverified_competencies]
